def bodyguards(string):
 lst = []
 string_list = string.split("\n")
 strink = "".join(string_list)
 l = len(strink)
 for i in range(4, l-4):
  if strink[i-3: i].isupper() == True and strink[i+1: i+4].isupper() == True and strink[i].islower() == True and strink[i-4].islower() == True and strink[i+4].islower() == True:
   lst.append(strink[i-3: i+4])
 print(lst)
 #clean_lst = []
 #for word in lst:
  #if not ("\n" in word):
...
bodyguards("""kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
